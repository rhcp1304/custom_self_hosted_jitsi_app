lk@meet:~$ sudo cat /etc/jitsi/jigasi/sip-communicator.properties
org.jitsi.jigasi.transcription.PUBLISH_TO_MQ=true
org.jitsi.jigasi.transcription.MQ_TYPE=rabbitmq
org.jitsi.jigasi.transcription.MQ_HOST=localhost
org.jitsi.jigasi.transcription.MQ_PORT=5672
org.jitsi.jigasi.transcription.MQ_EXCHANGE=jitsi-transcriptions-exchange
org.jitsi.jigasi.transcription.MQ_USERNAME=jitsi_admin
org.jitsi.jigasi.transcription.MQ_PASSWORD=Lenskart@123

org.jitsi.jigasi.transcription.google_language_code=en-IN
org.jitsi.jigasi.transcription.google_language_code_alternatives=hi-IN
org.jitsi.jigasi.transcription.customService=org.jitsi.jigasi.transcription.GoogleCloudTranscriptionService
...
# in SIP invite
#org.jitsi.jigasi.DEFAULT_JVB_ROOM_NAME=siptest@conference.meet-nso.diq.geoiq.ai

org.jitsi.jigasi.MUC_SERVICE_ADDRESS=conference.meet-nso.diq.geoiq.ai
...
# Enables support for startmuted, needs support in the IVR used for jigasi for users to be able to unmute
#org.jitsi.jigasi.ENABLE_SIP_STARTMUTED=false

# Enables support for visitors
#org.jitsi.jigasi.ENABLE_SIP_VISITORS=false
...
net.java.sip.communicator.impl.protocol.sip.acc1403273890647.SERVER_ADDRESS=
net.java.sip.communicator.impl.protocol.sip.acc1403273890647.USER_ID=
...
net.java.sip.communicator.impl.protocol.sip.acc1403273890647.DOMAIN_BASE=meet-nso.diq.geoiq.ai
...
net.java.sip.communicator.impl.protocol.jabber.acc-xmpp-1.ACCOUNT_UID=Jabber:jigasibrewery@internal.auth.meet-nso.diq.geoiq.ai
net.java.sip.communicator.impl.protocol.jabber.acc-xmpp-1.USER_ID=jigasibrewery@internal.auth.meet-nso.diq.geoiq.ai
...
net.java.sip.communicator.impl.protocol.jabber.acc-xmpp-1.PASSWORD=Lenskart@123
...
net.java.sip.communicator.impl.protocol.jabber.acc-xmpp-1.BREWERY=JigasiBrewery@auth.meet-nso.diq.geoiq.ai
net.java.sip.communicator.impl.protocol.jabber.acc-xmpp-1.BOSH_URL_PATTERN=https://{host}{subdomain}/http-bind?room={roomName}

net.java.sip.communicator.impl.protocol.jabber.acc-xmpp-1.DOMAIN_BASE=meet-nso.diq.geoiq.ai

# we can receive dial/hangup only from the control muc
org.jitsi.jigasi.ALLOWED_JID=JigasiBrewery@auth.meet-nso.diq.geoiq.ai

# when checking other participants whether they are jibri/jigasi we can also check the the domain they use for connecting
#org.jitsi.jigasi.TRUSTED_DOMAINS=["recorder.meet-nso.diq.geoiq.ai", "sipjibri.meet-nso.diq.geoiq.ai", "jigasi.meet-nso.diq.geoiq.ai"]
...
#org.jitsi.jigasi.xmpp.acc.DOMAIN_BASE=meet-nso.diq.geoiq.ai
...
org.jitsi.jigasi.xmpp.acc.USER_ID=jigasibrewery
org.jitsi.jigasi.xmpp.acc.PASSWORD=Lenskart@123
org.jitsi.jigasi.xmpp.acc.auth.domain=internal.auth.meet-nso.diq.geoiq.ai
...
GOOGLE_APPLICATION_CREDENTIALS=/etc/jitsi/jigasi/credentials.json
lk@meet:~$ 