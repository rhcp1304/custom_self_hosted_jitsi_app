        ...
        <div className="flex flex-col md:flex-row gap-4 w-full md:w-auto">
          <div className="flex items-center gap-2 w-full md:w-auto">
            ...
            <input
              ...
              className={`flex-1 min-w-0 px-4 py-2 rounded-lg bg-amber-300 text-sm text-black-900 placeholder-gray-900/70 border border-black-600 focus:border-black-700 focus:ring-1 focus:ring-amber-700 transition-colors`}
